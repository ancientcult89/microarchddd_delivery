...
namespace DeliveryApp.Infrastructure.Adapters.Postgres.Migrations
{
    ...
    [Migration("20250930095911_AddOutbox")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliveryApp.Core.Domain.Model.OrderAggrerate.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("DeliveryApp.Core.Domain.Model.OrderAggrerate.Order", b =>
                {
                    ...
                    b.OwnsOne("DeliveryApp.Core.Domain.Model.OrderAggrerate.OrderStatus", "Status", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uuid");
